      ...
      <form className='flex flex-col lg:flex-row gap-6 lg:items-end lg:mt-10'>
        <div className='flex flex-col gap-2 lg:w-1/3'>
          ...
          <input
            ...
            className='w-full lg:text-xl py-7 px-10 rounded-full lg:rounded-r-none bg-[#F5F5F5] text-sm text-gray-900 placeholder:text-gray-400 border-none outline-none focus:ring-2 focus:ring-gray-200 transition-all font-rubik'
          />
        </div>
        ...
        <div className='flex flex-col gap-2 lg:w-1/3'>
          ...
          <input
            ...
            className='w-full lg:text-xl py-7 px-10 rounded-full lg:rounded-none bg-[#F5F5F5] text-sm text-gray-900 placeholder:text-gray-400 border-none outline-none focus:ring-2 focus:ring-gray-200 transition-all font-rubik'
          />
        </div>
