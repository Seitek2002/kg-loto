    ...
    <section className='my-12 lg:my-25' id='check'>
      ...
      <form className='flex flex-col lg:flex-row gap-6 lg:items-end lg:mt-10'>
        ...
        <button
          ...
          className='mt-4 cursor-pointer lg:rounded-l-none lg:mt-0 lg:text-xl w-full lg:w-1/2 h-11.5 lg:h-auto lg:py-7 bg-[#262626] text-white rounded-full font-bold text-xs uppercase tracking-wider hover:bg-black active:scale-[0.98] transition-all shadow-lg'
        >
          Проверить
        </button>
      </form>
