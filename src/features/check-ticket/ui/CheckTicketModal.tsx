...
import { useCheckTicket } from "@/entities/ticket/api/ticketApi";
        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col">
            ...
            <input
              ...
              className="w-full bg-white border border-gray-200 rounded-2xl px-5 py-4 font-bold font-rubik text-sm text-[#4B4B4B] outline-none focus:border-[#5C73F1] focus:shadow-[0_0_12px_0_rgba(92,115,241,0.5)] transition-all placeholder:text-gray-300 mb-2"
            />
