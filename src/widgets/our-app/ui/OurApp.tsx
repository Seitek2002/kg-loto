...
const StoreButton = ({
  ...
  return (
    <a
      ...
      className="flex items-center gap-3 bg-[#1E1E1E] text-white px-6 py-3 rounded-full hover:bg-black active:scale-95 transition-all min-w-50 shadow-md"
    >
      {isApple ? (
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="max-w-md mb-8 text-xs lg:text-base text-[#6E6E6E] my-3 leading-relaxed font-rubik">
          {t("desc")}
        </div>
