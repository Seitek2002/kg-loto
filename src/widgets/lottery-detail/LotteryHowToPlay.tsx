...
import { LotteryRule } from "@/entities/lottery/model/types";
...
export const LotteryHowToPlay = async ({ rules }: { rules: LotteryRule[] }) => {
  ...
  return (
    <section className="mb-12 md:mb-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8 bg-white shadow-sm border border-gray-100 p-4 rounded-3xl md:rounded-4xl">
        {rules.map((step) => (
          <div key={step.id} className="flex flex-col gap-4 max-w-107.5">
            {step.image && (
