...
import { LotteryPrizeTier } from "@/entities/lottery/model/types";

import { DraggableScroll } from "@/shared/ui/DraggableScroll";
      ...
      <div className="hidden md:block w-full mt-4 bg-white shadow-sm rounded-4xl border border-gray-100 overflow-hidden relative">
        ...
        >
          ...
          <div className="sticky left-0 z-10 flex items-center bg-white pl-10 pr-6 py-2 shadow-[10px_0_15px_-3px_rgba(255,255,255,0.8)]">
            ...
            <div className="w-px h-20 bg-[#6E6E6E] ml-5.5"></div>
          </div>

          {/* СПИСОК ПРИЗОВ */}
          <div className="flex gap-18.25 flex-nowrap pl-10 pr-10">
            {prizeTiers.map((item) => (
              <div
                key={item.id}
