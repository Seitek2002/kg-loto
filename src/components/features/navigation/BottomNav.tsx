...
export function BottomNav() {
  ...
  return (
    <div className='fixed bottom-6 left-4 right-4 z-50 flex items-center justify-between gap-3 max-w-md mx-auto pointer-events-none'>
      ...
      <nav className='glass flex-1 pointer-events-auto bg-gray-100/50 border border-gray-100 rounded-full shadow-2xl shadow-gray-200/50 p-1.5 flex justify-between items-center'>
        {navItems.map((item) => {
          // Логика активности
          const isActive =
            item.href === '/'
